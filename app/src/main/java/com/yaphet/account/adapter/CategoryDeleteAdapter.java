...
public class CategoryDeleteAdapter extends BaseAdapter{
    ...
    public CategoryDeleteAdapter(List<CategoryBean> list_category, Context context,DbManager dbManager){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            convertView = LayoutInflater.from(context).inflate(R.layout.category_delete_item,parent,false);
    ...
    class ViewHolder{
        ...
        public  ViewHolder(View view){
            ...
            btn_category = (Button) view.findViewById(R.id.bt_delete_category);
        }
    }
}
